...
const cdtime = 7;
client.login("Nzg0MzA1NzI3MTM2MDcxNzIy.X8nXoQ.i3eYGSOLUsy7idYRCwkxfkl6eus");
///////////////////////////////////////////////////////////////////////////////
client.on("ready", () => {
  console.log(`${client.user.tag}`);
  console.log(`Guilds: ${client.guilds.size}`);
  console.log(`Users: ${client.users.size}`);
  client.user.setActivity(`${prefix}help | @mention`, {
    Type: "Playing"
  });
});
///////////////////////////////////////////////////////////////////////////////
...
client.on("message", async message => {
 ...
 <a:emoji_16:798111136145997824> \`c!unlock\` <:F1E82E268E164632BE9FF35CA363EB0B:798508498605965333>
 <a:emoji_16:798111136145997824> \`c!clear\`
 <a:emoji_16:798111136145997824> \`c!ban\` : @User
 <a:emoji_16:798111136145997824> \`c!kick\`: @User
 <a:emoji_16:798111136145997824> \`c!unban\`: Id / all
 <a:emoji_16:798111136145997824> \`c!mute\`: @User / Id
 <a:emoji_16:798111136145997824> \`c!unmute\`: @User / Id
 <a:emoji_16:798111136145997824> \`c!bans\`,
 
 <a:emoji_5:797912346759659591> __**Security Commands**__ <a:emoji_5:797912346759659591>
 <a:emoji_25:808613173967847455> \`c!anti kick \` [Number]
 <a:emoji_25:808613173967847455> \`c!anti ban \` [Number]
 <a:emoji_25:808613173967847455> \`c!anti roleC \`[Number]
 <a:emoji_25:808613173967847455> \`c!anti roleD \` [Number]
 <a:emoji_25:808613173967847455> \`c!anti channelC \` [Number]
 <a:emoji_25:808613173967847455> \`c!anti channelD \` [Number]
 <a:emoji_25:808613173967847455> \`c!anti bot [on/off]\`
 <a:emoji_25:808613173967847455> \`c!anti problem [on/off]\`
 <a:emoji_25:808613173967847455> \`c!setting \`
 
 [security Support](https://discord.gg/CHUKd9z87E)
...
///////////////////////////////////////////////////////////////////////////////
client.on("message", async message => {
  if (message.content.startsWith("<@803650426570014730>")) {
    if (cooldown.has(message.author.id)) {
      return message.channel
        .send(`<@${message.author.id}>, <a:emoji_13:798075791065350174> Please wait for 10 second <a:emoji_13:798075791065350174>`)
        .then(m => {
...
**report a problem**
If there is, you can always join the support server by type c!support. or DM a Developer. Developers you can message include Calli#4415
**Extra Links**
[security Support](https://discord.gg/CHUKd9z87E) • [invite security](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)`);
...
client.on("message", async message => {
  if (message.content.startsWith(prefix + "invite")) {
    ...
    message.author.send("`invite link`https://discord.com/api/oauth2/authorize?client_id=803650426570014730&permissions=8&scope=bot");
  }
});
///////////////////////////////////////////////////////////////////////////////
client.on("message", async message => {
  if (message.content.startsWith(prefix + "support")) {
    ...
    message.channel.send("**Check Your DM**")
    message.author.send("**BOT SUPPORT SERVER** https://discord.gg/CHUKd9z87E");
  }
});
///////////////////////////////////////////////////////////////////////////////
client.on("message", async message => {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    message.channel.send(
      `<@${message.author.id}>,**AntiBot Is Enable${rast}**`
    );
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "anti bot off")) {
    ...
    message.channel.send(
      `<@${message.author.id}>,**AntiBot Is Disable${rast}**`
    );
    fs.writeFile("./antibots.json", JSON.stringify(antibots), err => {
      if (err)
        console.error(err).catch(err => {
...
client.on("message", message => {
  ...
  if (command == prefix + "unban") {
    ...
    if (args == "all") {
      ...
      return message.channel.send("<a:emoji_26:809385634149826611> Unban all members");
    }
    if (!args) return message.channel.send("**Please Type the member ID / all**");
    message.guild
      .unban(args)
      .then(m => {
        message.channel.send(`<a:emoji_26:809385634149826611> Unban this member ${m.username}`);
      })
      .catch(stry => {
        message.channel.send(
...
client.on("message", async message => {
  ...
  if (["ban", "kick"].includes(commandName)) {
    ...
    user[mode](
      ...
      .then(() =>
        message.channel.send(
          `<a:emoji_26:809385634149826611> ${mode == "ban" ? "Bann" : mode}ed __${user.user.tag}__`
        )
      )
      .catch(console.error);
  }
